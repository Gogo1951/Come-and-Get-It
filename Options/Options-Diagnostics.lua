...
--[[
	...
	header widgets don't support `hidden`, so the gated sections inline their
	header widgets with `hidden` functions; the always-visible warning and
	toggle are plain widgets.
]]
