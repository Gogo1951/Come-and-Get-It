...
L["OPTIONS_OUTPUT_NOTE"] =
	"Local (/1) est le canal Général de la zone et dépend de la strate. Votre annonce atteint toute la zone, mais seuls les joueurs présents sur votre strate actuelle la verront."
