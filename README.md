...
🌿 **Herbs, Ore, and Chests** // Works with Herbalism nodes, Mining veins, and locked Treasure Chests. Every callout is addressed to the people who can actually do something about it — Herbalists, Miners, or Rogues.

📍 **Coordinates and Zone Included** // Each message carries the node name, your map coordinates, and the zone, so anyone nearby can actually find it.
...
🦺 **Safety First** // Nothing fires inside dungeons and raids, during combat, or while you're mid-message, so it never steals your movement keys in a fight or spams a group that can't gather it anyway.
...
2. Log in.
3. Open Options > AddOns > Come & Get It and pick where your callouts go — Local, Say, Yell, Party, or Guild.
...
6. Come & Get It // *"If you ping it, they will come."*
...
A cross raid marker so it stands out in a busy chat window, who the callout is for, what's sitting there, and exactly where to find it.
